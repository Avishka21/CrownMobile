...
<table width="728" height="177" border="0" align="center">
       <tbody>
         <tr>
           <td height="173"><p><h1>View My Products</h1></p>
             <p>&nbsp;</p>
             <p>&nbsp;</p>
		   ...
		   <div class="image"><a href="<?php echo $row['ImagePath'];?>">
			    ...
			    <input type="button" name="xo" id="xo" value="Submit">
				<a href="editproducts.php?id=<?php	
				echo $row['productsID']; ?>"></a>  <a href="deleteproducts.php?id=<?php
			    echo $row['productsID']; ?>"></a>
